...
export const HomePage = () => {
  ...
  return <div className="w-full h-screen flex flex-col items-center justify-center">
    ...
    <div className="absolute bottom-6 left-0 right-0 px-6 py-4 ">
      <Button onClick={() => history.push('/login')}className='border-2 h-10 w-full border-gray-800 font-semibold text-sm'>
        로그인
      </Button>
      <Button onClick={() => history.push('/signup')} className='border-2 h-10 w-full border-gray-900 mt-3 bg-gray-500 text-white font-semibold text-sm'>
        회원가입
      </Button>
    </div>
